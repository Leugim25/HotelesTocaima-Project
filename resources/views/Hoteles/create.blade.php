...
@section('content')
    ...
    <h2 class="text-center mb-4"><strong>CREA UN NUEVO HOTEL</strong></h2>
    <div class="contener">
        <div class="principal">
                        ...
                        <form method="POST" action="{{ route('hoteles.store') }}" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="pagina">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="titulo" class= "form-control @error('titulo') is-invalid @enderror" id="titulo" placeholder="Ej: Hotel el Ejemplo" value="{{ old('titulo') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nit" class= "form-control @error('nit') is-invalid @enderror" id="nit" placeholder="Ej: 123.456.789-0" value="{{ old('nit') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="direccion" class= "form-control @error('direccion') is-invalid @enderror" id="direccion" placeholder="Ej: Calle 1 #2-3 B/ejemplo" value="{{ old('direccion') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="celular" class= "form-control @error('celular') is-invalid @enderror" id="celular" placeholder="Ej: 3124567890" value="{{ old('celular') }}">
                            ...
                            <div class="pagina 3">
                                ...
                                <div class="form-group mt-2 category">
                                    ...
                                    <input id="descripcion" type="hidden" name="descripcion" value="{{ old('descripcion') }}" placeholder="Aquí va una breve descripción del HOTEL">
                                    <trix-editor 
